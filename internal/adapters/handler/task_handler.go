...
func (h *TaskHandler) CreateTask(ctx *gin.Context) {
	...
	if err != nil {
		...
		HandleError(ctx, domain.ErrorCodeInternalServerError, nil, "Failed to create task")
		return
	}
	go func() {
...
func (h *TaskHandler) GetTask(ctx *gin.Context) {
	...
	if err != nil {
		...
		HandleError(ctx, domain.ErrorCodeInternalServerError, nil, "Failed to get task")
		return
	}
